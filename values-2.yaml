...
##
gitlabUrl: https://gitlab.com/cicd4900833/pipeline
...
##
runnerToken: "glrt-HADkoBH2yR2ZVkB9S_ww"
#
...
rbac:
  ...
  ## DEPRECATED: Please use `serviceAccount.name` instead
  ##
  serviceAccountName: "gitlab-runner-udm-dev"
...
service:
  ...
  # labels: {}
  labels:
  app.kubernetes.io/name: gitlab-runner-udm-dev
  app.kubernetes.io/instance: gitlab-runner-udm-dev
